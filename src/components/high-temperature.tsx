...
const DATA = [
    {
        prevYear: 1850,
        nextYear: 1900,
        text: 'Les premiers signes du réchauffement climatique',
        description: `Les premiers signes du réchauffement climatique sont détectés. La température moyenne de la planète a augmenté de 0,6 °C depuis le début de l'ère industrielle. La première conférence internationale sur le changement climatique a lieu à Genève.`,
    },
    {
        prevYear: 1900,
        nextYear: 1950,
        text: "Essor de l'industrialisation et augmentation des émissions",
        description: `Le début du XXe siècle voit une montée rapide de l'industrialisation, entraînant une augmentation des émissions de gaz à effet de serre. La combustion de combustibles fossiles devient un contributeur majeur à la tendance actuelle du réchauffement climatique.`,
    },
    {
        prevYear: 1950,
        nextYear: 2000,
        ...
        <div className='relative  h-full overflow-hidden bg-gradient-to-b from-sky-600 to-[#b6fdff]'>
            <Range
                ...
                renderTrack={({ props, children }) => (
                    <div
                        {...props}
                        className='mx-auto mt-8 h-4 w-full max-w-5xl rounded-full bg-gradient-to-r from-green-500 via-yellow-500 to-red-600'
                    >
                        {children}
                    </div>
                )}
                renderThumb={({ props }) => (
                    <div
                        {...props}
                        className='absolute flex h-6 w-6 items-center justify-center rounded-full border-none bg-white shadow-lg'
                    >
